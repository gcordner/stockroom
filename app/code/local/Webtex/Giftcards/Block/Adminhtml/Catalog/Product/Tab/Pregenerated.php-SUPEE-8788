...
*/
        ...
        $this->getUploader()->getUploaderConfig()
            ...
            ->setTarget(Mage::getModel('adminhtml/url')->addSessionParam()->getUrl('adminhtml/product/import/id/'.$this->_getProduct()->getId()));

        $browseConfig = $this->getUploader()->getButtonConfig();
        $browseConfig
            ->setAttributes(array(
                'accept' => $browseConfig->getMimeTypesByExtensions('csv')
            ));
