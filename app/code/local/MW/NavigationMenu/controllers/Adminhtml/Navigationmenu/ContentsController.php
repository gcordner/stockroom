...
class MW_NavigationMenu_Adminhtml_Navigationmenu_ContentsController extends Mage_Adminhtml_Controller_action
{
	protected function _isAllowed()
	{
		return Mage::getSingleton('admin/session')->isAllowed('navigationmenu/contents');
	}
