...
class Bronto_Email_Block_Adminhtml_System_Email_Template_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        if ($templateId) {
            $fieldset->addField(
                'used_currently_for', 'label', array(
            ...
            if (!$this->getEmailTemplate()->getSystemConfigPathsWhereUsedCurrently()) {
                ...
                $fieldset->addField(
                    'note_used_currently', 'label', array(
                    'label'              => '',
        ...
        $sendtype = $fieldset->addField(
            'template_send_type', 'select', array(
        ...
        $fieldset->addField(
            'bronto_message_id', 'select', array(
        ...
        if (Mage::helper('bronto_product')->isEnabledForAny()) {
            $fieldset->addField(
                'product_recommendation', 'select', array(
        ...
        $fieldset->addField(
            'template_variables_key', 'label', array(
        ...
        $fieldset->addField(
            'orig_template_text', 'textarea', array(
        ...
        $fieldset->addField(
            'orig_template_variables', 'hidden', array(
            'name' => 'orig_template_variables',
            )
        );

        $fieldset->addField(
            'variables', 'hidden', array(
            'name'  => 'variables',
        ...
        $fieldset->addField(
            'template_variables', 'hidden', array(
        ...
        $fieldset->addField(
            'insert_variable', 'note', array(
            'text' => $insertVariableButton->toHtml()
            )
        );

        $fieldset->addField(
            'template_text', 'textarea', array(
            'name'         => 'template_text',
        ...
        if (!$this->getEmailTemplate()->isPlain()) {
            $fieldset->addField(
                'template_styles', 'textarea', array(
