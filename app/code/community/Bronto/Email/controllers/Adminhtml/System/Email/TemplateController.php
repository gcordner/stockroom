...
class Bronto_Email_Adminhtml_System_Email_TemplateController extends Mage_Adminhtml_System_Email_TemplateController
{
    ...
    public function ajaxlistAction()
    {
        ...
        foreach ($messages as $message) {
            if ($message['value'] == $template->getBrontoMessageId()) {
                $body .= sprintf('<option value="%s" selected="selected">%s</option>', $message['value'], $message['label']);
            } else {
                $body .= sprintf('<option value="%s">%s</option>', $message['value'], $message['label']);
            }
        }
    ...
    public function ajaxtemplateAction()
    {
        ...
        $this->getResponse()->setBody($templateContent);
    }
    ...
    public function importEditAction()
    {
        ...
        $this->_addContent(
            $this->getLayout()->createBlock('bronto_email/adminhtml_system_email_import_edit', 'template_edit')
    ...
    public function brontoNewAction()
    {
        ...
        $this->_addContent(
            $this->getLayout()->createBlock('bronto_email/adminhtml_system_email_template_edit', 'template_edit')
            ->setEditMode((bool)$this->getRequest()->getParam('id'))
        );
        $this->renderLayout();
    }
