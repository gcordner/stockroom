...
class Stockroom_Affiliateoptout_Block_Adminhtml_Program_Edit_Tab_Form extends Magestore_Affiliateplusprogram_Block_Adminhtml_Program_Edit_Tab_Form
{
	protected function _prepareForm()
	{
        ...
        $fieldset->addField('allow_optout', 'select', array(
          'name'      => 'allow_optout',
          'label'     => Mage::helper('affiliateplusprogram')->__('Allow opt-out'),
          'values'	  => Mage::getSingleton('adminhtml/system_config_source_yesno')->toOptionArray(),
        ));
