...
LIST;
    ...
    protected function _runReset(array $tasks, $full = false, $revert = false)
    {
        foreach ($tasks as $task) {
            ...
            print "{$this->_getTaskName($task)}: Finished \r\n\r\n";
        }
    }
    ...
    protected function _revert($target, $version)
    {
        ...
        print '    Core Resource entry reverted to ' . $version . ' for ' . $this->_getTaskName($target) . "\r\n";
    }
    ...
    protected function _reset($target)
    {
        ...
        print '    Core Resource entry removed for ' . $this->_getTaskName($target) . "\r\n";
    }
    ...
    protected function _clearConfig($target)
    {
        ...
        print '    Core Config Data entries removed for ' . $this->_getTaskName($target) . "\r\n";
    }
    ...
    protected function _getRevertVersion($target)
    {
        ...
        if (!$curVersion) {
            print '    ! Could not get Current module version for ' . $target;
            return false;
        }
