 ...
 * ID:            %!uniqueid!%
 * Packaged:      %!packaged!%
 * Last Modified: 2016-03-21T14:01:56+01:00
...
class Xtento_OrderExport_Model_Output_Xsl extends Xtento_OrderExport_Model_Output_Abstract
{
    ...
    public function convertData($exportArray)
    {
        ...
        foreach ($outputFormats as $outputFormat) {
            ...
            if (($fileType == 'invoice_pdf' || $fileType == 'packingslip_pdf' || $fileType == 'creditmemo' || preg_match('/fooman\_/', $fileType)) && Mage::registry('is_test_orderexport') !== true) {
                $orderIds = array();
