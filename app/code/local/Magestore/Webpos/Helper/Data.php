...
//        $floCashin = $arrCashin[1];
	...
	public function enableShipEntireItems(){
		return Mage::getStoreConfig('wepos/general/ship_entire_items',Mage::app()->getStore()->getId());
	}	
	
	public function enableVirtualNumberBoard(){
		return Mage::getStoreConfig('wepos/general/use_virtual_keyboard_multipayments',Mage::app()->getStore()->getId());
	}
