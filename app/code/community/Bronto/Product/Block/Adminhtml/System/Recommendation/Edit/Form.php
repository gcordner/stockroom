...
class Bronto_Product_Block_Adminhtml_System_Recommendation_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $primarySource = $fieldset->addField(
            'primary_source', 'select', array(
            'name' => 'primary_source',
            'required' => true,
        ...
        $manualPri = $fieldset->addField(
            'manual_primary_source', 'text', array(
        ...
        $manualPriHide = $fieldset->addField(
            'primary_source_hidden', 'hidden', array(
            'name' => 'primary_source_hidden'
            )
        );

        $secondSource = $fieldset->addField(
            'secondary_source', 'select', array(
        ...
        $manualSec = $fieldset->addField(
            'manual_secondary_source', 'text', array(
        ...
        $manualSecHide = $fieldset->addField(
            'secondary_source_hidden', 'hidden', array(
            'name' => 'secondary_source_hidden'
            )
        );

        $fallbackSource = $fieldset->addField(
            'fallback_source', 'select', array(
        ...
        $manualFal = $fieldset->addField(
            'manual_fallback_source', 'text', array(
        ...
        $manualFalHide = $fieldset->addField(
            'fallback_source_hidden', 'hidden', array(
            'name' => 'fallback_source_hidden'
            )
        );

        $exclusionSource = $fieldset->addField(
            'exclusion_source', 'hidden', array(
        ...
        $manualExl = $fieldset->addField(
            'manual_exclusion_source', 'text', array(
        ...
        $manualExlHide = $fieldset->addField(
            'exclusion_source_hidden', 'hidden', array(
    ...
    protected function _prepareContentTagBasedForm($fieldset)
    {
        ...
        $previewButton = $fieldset->addField(
            'preview_button', 'text', array(
            'label' => '&nbsp;',
