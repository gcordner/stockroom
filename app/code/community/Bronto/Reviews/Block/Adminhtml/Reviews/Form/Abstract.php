    ...
    implements Bronto_Reviews_Block_Adminhtml_Reviews_Typer
{
    ...
    protected function _prepareForm()
    {
        ...
        if ($reason = $this->_disabledReason($product)) {
            $fieldset->addField(
                "{$this->getPostType()}_disabled", 'label', array(
            ...
            $message = $fieldset->addField(
                $messageType, 'select', array(
    ...
    protected function _setUpEnablement($fieldset)
    {
        ...
        if ($this->_storeId) {
            ...
            $useDefault = $fieldset->addField(
                $useDefaultType, 'select', array(
        ...
        $this->_enabled = $fieldset->addField(
            $enableType, 'select', array(
    ...
    protected function _defaultOverride($fieldset, $post, $elementDef)
    {
        ...
        $override = $fieldset->addField(
            $overrideKey, "select", array(
