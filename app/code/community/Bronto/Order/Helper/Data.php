...
class Bronto_Order_Helper_Data extends Bronto_Common_Helper_Data implements Bronto_Common_Helper_DataInterface
{
    ...
    const XML_PATH_ORDER_REST_ENABLED   = 'bronto_order/settings/rest_enabled';
    ...
    const XML_PATH_BRONTO_ORDER_STATUS  = 'bronto_order/settings/bronto_order_status';
    ...
    const XML_PATH_OTHER         = 'bronto_order/import/other';
     ...
     * @return string
     */
    public function getOtherAttributeCode($scope = 'default', $scopeId = 0)
    {
        return $this->getAdminScopedConfig(self::XML_PATH_OTHER, $scope, $scopeId);
    }

    /**
     * Returns the attribute designated as 'Other' in the import configuration
     * 
     ...
     */
    public function getOtherAttribute(\Mage_Catalog_Model_Product $product, $scope, $scopeId)
    {
        $attributeCode = $this->getOtherAttributeCode($scope, $scopeId);
        if ($attributeCode) {
     ...
     * @return string
     */
    public function getBrontoOrderStatus($scope = 'default', $scopeId = 0)
    {
        return (string) $this->getAdminScopedConfig(self::XML_PATH_BRONTO_ORDER_STATUS, $scope, $scopeId);
    }
